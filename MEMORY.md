...
- [2025-06] modules: common-events, common-test, api-gateway, order-service, payment-service, catalog-service, notification-service
...
- Branch naming: <type>/<scope>-<short-desc> e.g. feat/order-service-retry
