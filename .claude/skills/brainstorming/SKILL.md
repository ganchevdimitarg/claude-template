...
4. **Propose approaches** — when more than one is genuinely competitive, give 2–3 with trade-offs and your recommendation; when one is clearly right, name it with a one-line rationale and the closest alternative you rejected
...
- **Explore alternatives when they compete** - propose 2–3 only when more than one is genuinely viable; manufacturing strawmen wastes a turn (YAGNI applies to options too)
